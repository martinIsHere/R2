...
def update_objects():
    """
    updates all objects' position, velocity and acceleration
    """
#1391E6/199E28
...
def handle_mousebuttondown():
    ...
    if MB1:
        ...
        add_object(transform_window_to_plane(pygame_vec), pygame_color, input_mass)
    if MB3:
        input_mass=int(input("Mass: "))
        ...
        pygame_color=pygame.Color(color_r, color_g, color_b)
        pygame_vec=pygame.Vector2(MX, MY)
        add_object_with_vel(transform_window_to_plane(pygame_vec), pygame_color, input_mass, pygame.Vector2(input_velx, input_vely))
    if MB2:
        global_mb2_down=True
def handle_mousebuttonup():
    """
